...
<template>
    <Dialog>
        ...
        <DialogTrigger as-child>
            <Button variant="outline" class="bg-primary text-white sm:mb-10 lg:mb-0 rounded-2xl hover:bg-primary hover:text-white">
                <Icon icon="iconoir:page-edit" size="1.4em" />ระบุข้อมูลลดหย่อนภาษี
