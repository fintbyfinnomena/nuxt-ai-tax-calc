<template>
  <div class="w-11/12 md:w-5/6 lg:w-4/6 h-screen mx-auto flex flex-col">
    <div id="wrap" class="bg-white grid mb-28 mt-14 md:my-20 lg:gap-10 xl:gap-0 lg:grid-cols-12 shadow-lg  p-5 md:p-15 lg:p-20 rounded-xl overflow-scroll">
      <div class="mr-auto place-self-center lg:col-span-7 justify-center items-center">
        <div class="lg:hidden text-center mb-10">
          <img src="../assets/img/chat-logo.png" alt="logo" style="height: 15rem"/>
        </div>
